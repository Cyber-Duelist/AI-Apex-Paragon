/* ========================================
   ALIEN BOOT SEQUENCE & MATRIX DATA-RAIN
   ======================================== */
(function() {
    // ---- 1. BOOT SEQUENCE ----
    ...
    if (canvas) {
        ...
        const alienChars = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789@#$%^&*()_+|~-=\\`{}[]:\";'<>?,./".split("");
        const fontSize = 16;
